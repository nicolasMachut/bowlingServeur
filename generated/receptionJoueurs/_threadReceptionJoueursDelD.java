...
{
    public String inscriptionJoueur(final String[] maListe, java.util.Map<String, String> __ctx, Ice.Instrumentation.InvocationObserver __observer)
        throws IceInternal.LocalExceptionWrapper
    {
        ...
        try
        {
            __direct = new IceInternal.Direct(__current)
            {
                ...
                {
                    threadReceptionJoueurs __servant = null;
                    if(__obj == null || __obj instanceof threadReceptionJoueurs)
                    {
                        __servant = (threadReceptionJoueurs)__obj;
                    }
                    else
                    {
                        throw new Ice.OperationNotExistException(__current.id, __current.facet, __current.operation);
                    }
                    __result.value = __servant.inscriptionJoueur(maListe, __current);
